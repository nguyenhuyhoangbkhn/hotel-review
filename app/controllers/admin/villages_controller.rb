class Admin::VillagesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @village.save
        format.html { redirect_to [:admin, @village], notice: 'Village was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @village.update(village_params)
        format.html { redirect_to [:admin, @village], notice: 'Village was successfully updated.' }
  ...
  def destroy
    @village.destroy
    respond_to do |format|
      format.html { redirect_to admin_villages_url, notice: 'Village was successfully destroyed.' }
